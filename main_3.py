...
df = Preprocessor_3.fetch_time_features(df)

# sidebar
st.sidebar.title("Filters")

# Filters
selected_year = Preprocessor_3.multiselect("Select Year", df["Financial_Year"].unique())
selected_retailer = Preprocessor_3.multiselect("Select Retailer", df["Retailer"].unique())
selected_company = Preprocessor_3.multiselect("Select Company", df["Company"].unique())
selected_month = Preprocessor_3.multiselect("Select Month", df["Financial_Month"].unique())
...
with col5:
    ...
    retailer_count = Preprocessor_3.fetch_top_revenue_retailers(filtered_df)
...
with col6:
    ...
    company_count = Preprocessor_3.fetch_top_revenue_companies(filtered_df)
